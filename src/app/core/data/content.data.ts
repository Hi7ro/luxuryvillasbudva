import { DistanceItem, GuideArticle, Villa } from '../models/villa.model';
...
export const VILLAS: Villa[] = [
  {
    ...
    metaDescription: {
      de: 'Private Luxusvilla in Reževići bei Budva: 3 Schlafzimmer, eigener Pool, Olivengarten und Meerblick für bis zu 6 Gäste. Ab 500 € pro Nacht.',
      en: 'Private luxury villa in Reževići near Budva: 3 bedrooms, private pool, olive garden and sea views for up to 6 guests. From €500 per night.',
      ru: 'Частная вилла в Режевичи рядом с Будвой: 3 спальни, бассейн, оливковый сад и вид на море для 6 гостей. От 500 € за ночь.',
      es: 'Villa privada en Reževići, cerca de Budva: 3 dormitorios, piscina, olivar y vistas al mar para 6 huéspedes. Desde 500 € por noche.',
    },
  },
  {
    slug: 'villa-lumina',
    ...
    metaDescription: {
      de: 'Luxusvilla in Reževići bei Budva für 6 Gäste: privater Pool, Dachterrasse, Glasfaser-Internet und Panoramablick. Ab 500 € pro Nacht.',
      en: 'Luxury villa in Reževići near Budva for 6 guests: private pool, rooftop terrace, fibre internet and panoramic views. From €500 per night.',
      ru: 'Вилла в Режевичи рядом с Будвой для 6 гостей: бассейн, терраса на крыше, быстрый интернет и панорамный вид. От 500 € за ночь.',
      es: 'Villa de lujo en Reževići, cerca de Budva, para 6 huéspedes: piscina, azotea, fibra y vistas panorámicas. Desde 500 € por noche.',
    },
  },
];
